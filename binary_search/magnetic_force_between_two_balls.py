...
of magnetic force between two balls if they are put in his new invented basket.
...
The minimum magnetic force is 3. We cannot achieve a
...
ic(max_distance([5, 4, 3, 2, 1, 1000000000], 2))
