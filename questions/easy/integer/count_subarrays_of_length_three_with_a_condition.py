...
return the number of subarrays of length 3 such
that the sum of the first and third numbers equals
...
Output: 0
Explanation:
[1,1,1] is the only subarray of length 3. However,
...
ic(count_subarrays(nums=[1, 2, 1, 4, 1]))
