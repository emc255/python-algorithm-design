...
def is_circular_sentence(sentence: str) -> bool:
    ...
    if len(sentence_list) <= 1:
        s = sentence_list[0]
        return s[0] == s[len(s) - 1] if len(sentence_list) == 1 else True
...
ic(is_circular_sentence(sentence="leetcode exercises sound delightful"))
ic(is_circular_sentence(sentence="Leetcode is cool"))
ic(is_circular_sentence(sentence="Leetcode"))
ic(is_circular_sentence(sentence="Leetcode eisc cool"))
