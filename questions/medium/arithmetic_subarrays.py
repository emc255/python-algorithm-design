...
More formally, a sequence s is arithmetic
...
and two arrays of m integers each, l and r,
representing the m range queries, where the ith query is the range [l[i],
...
def check_arithmetic_sub_arrays(nums: list, l: list, r: list) -> list:
    def check_sub_arrays(left, right):
    ...
    for index in range(len(l)):
        result.append(check_sub_arrays(l[index], r[index]))
    return result


ic(check_arithmetic_sub_arrays([4, 6, 5, 9, 3, 7], [0, 0, 2], [2, 3, 5]))
