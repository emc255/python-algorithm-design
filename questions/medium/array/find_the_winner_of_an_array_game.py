...
def get_winner(arr: list, k: int) -> int:
    winner = -1
    counter = 0
    i, n = 0, 1
...
def get_winner_v2(arr: list, k: int) -> int:
    winner = arr[0]
    count = 0
...
ic(get_winner([2, 1, 3, 5, 4, 6, 7], 2))
ic(get_winner_v2([1, 9, 8, 2, 3, 7, 6, 4, 5], 7))
