...
Output:  "cbad"
Explanation: "a", "b", "c" appear in order,
...
he character "d" in s does not appear in order,
...
Other arrangements like "bacd" or "bcda" would also be valid,
...
ic(custom_sort_string("bcafg", "abcd"))
ic(custom_sort_string("kqep", "pekeq"))
