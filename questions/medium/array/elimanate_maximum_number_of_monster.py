...
You have a weapon that, once fully charged,
can eliminate a single monster. However,
...
def eliminate_maximum(dist: list, speed: list) -> int:
    max_kills = 0
...
ic(eliminate_maximum([1, 1, 2, 3], [1, 1, 1, 1]))
ic(eliminate_maximum([3, 2, 4], [5, 3, 2]))
