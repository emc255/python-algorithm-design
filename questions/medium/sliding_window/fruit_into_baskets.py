...
def total_fruit_v2(fruits: list[int]) -> int:
    ...
    for right in range(len(fruits)):
        ...
        # Shrink the window if there are more than 2 types
        while len(count) > 2:
            count[fruits[left]] -= 1
...
ic(total_fruit_v2(fruits=[1, 2, 3, 2, 2]))
ic(total_fruit_v2(fruits=[1, 2, 1]))
