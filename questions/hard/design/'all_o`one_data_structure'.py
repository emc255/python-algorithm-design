...
Design a data structure to store the strings' count with
the ability to return the strings with minimum and maximum counts.
...
all_one.inc("hello")
all_one.inc("abcde")
ic(all_one.getMaxKey())
all_one.dec("abcde")
ic(all_one.getMaxKey())
all_one.inc("abc")
all_one.inc("ccc")
all_one.inc("ccc")
ic(all_one.getMinKey())
ic(all_one.getMaxKey())
