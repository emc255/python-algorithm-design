...
that is, you cannot attend two events where one of them starts and the
...
Output: 9
Explanation:
Although the events do not overlap,
you can only attend 3 events. Pick the highest valued three.
...
ic(max_value(events=[[1, 1, 1], [2, 2, 2], [3, 3, 3], [4, 4, 4]], k=3))
