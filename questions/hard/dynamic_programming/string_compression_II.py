...
You need to delete at most k characters from s such that the run-length
...
Deleting any of the characters 'a' or 'c' would at most decrease
the length of the compressed string to 5,
